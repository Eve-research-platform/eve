/* Eve bundled QR encoder. Based on qrcode-terminal's vendored Kazuhiko Arase QRCode implementation (MIT). */
(function(global){
'use strict';
const modules={};
...
function req(name){
  ...
  if(!modules[key])throw new Error('QR module not found: '+name);
  const module={exports:{}};cache[key]=module;
  modules[key](module,module.exports,req);
  return module.exports;
}
global.EveQR={QRCode:req('index'),ErrorCorrectLevel:req('QRErrorCorrectLevel')};
})(window);
